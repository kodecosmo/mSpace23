...
export default function SideNavbarMolecule({ windowHeight = 0 }) {
    return (
        <>
            <aside id="default-sidebar" className="sticky top-[70px] left-0 z-40 w-full max-w-[18rem] h-fit min-h-screen transition-transform -translate-x-full sm:translate-x-0 overflow-y-auto overflow-x-hidden" aria-label="Sidenav" style={{ height: (windowHeight - 70) + "px" }}>
