            ...
            <aside id="default-sidebar" className="sticky top-[70px] left-0 z-40 w-full max-w-[18rem] h-screen transition-transform -translate-x-full sm:translate-x-0 overflow-y-auto overflow-x-hidden" aria-label="Sidenav" style={{ height: (windowHeight - 70) + "px" }}>
                <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800 ">
                    <ul className="space-y-2">
                        <li>
                            <Link href="/dashboard" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <button type="button" className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap">Questions</span>
                            ...
                            <ul id="dropdown-pages" className="hidden py-2 space-y-2">
                                <li>
                                    <Link href="#" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Post Question</Link>
                                </li>
                                <li>
                                    <Link href="#" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Questions</Link>
                                </li>
                            </ul>
                        </li>
                        <li>
