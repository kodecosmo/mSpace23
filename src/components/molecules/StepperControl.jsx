  ...
  return (
    <section className="container flex justify-around mt-4 mb-8">
      ...
      <button 
        ...
        className="bg-primary text-white uppercase px-4 py-2 rounded-xl font-semibold cursor-pointer hover:bg-slate-700 hover:text-white transition duration-200 ease-in-out"
      >
