...
function TableBodyMolecule({ data, selectedQuestion, updateModalButtonRef, readModalButtonRef, deleteModalButtonRef }) {
    ...
    const listQuestions = data.map((question, i) =>
        <tr className="border-b dark:border-gray-700" key={i}>
            ...
            <TD value={<ul className="py-1 text-sm inline-flex" aria-labelledby="apple-imac-27-dropdown-button">
                <li>
                    <button onClick={() => { selectedQuestion(question); updateModalButtonRef.current.click() }} type="button" className="flex w-full items-center py-2 px-3 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                ...
                <li>
                    <button onClick={() => { selectedQuestion(question); readModalButtonRef.current.click() }} type="button" className="flex w-full items-center py-2 px-3 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                ...
                <li>
                    <button onClick={() => { selectedQuestion(question); deleteModalButtonRef.current.click() }} type="button" className="flex w-full items-center py-2 px-3 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
