...
export default function NavbarMolecule({type = "default"}) {
    ...
    return (
        <nav ref={ref} id="nav" className={(type == "dashboard") ? "bg-white dark:bg-gray-900 fixed top-0 w-full z-50 border-b border-gray-200 border-solid" : "bg-white border-b border-b-gray-100 dark:bg-gray-900 fixed top-0 w-full z-50"}>
