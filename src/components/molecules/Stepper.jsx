  ...
  const displaySteps = newStep.map((step, index) => {
    return (
      ...
      <div className="relative flex flex-col items-center text-primary">
        <div className={`rounded-full transition duration-500 ease-in-out border border-primary h-12 w-12 flex items-center justify-center py-3 ${step.selected ? "bg-primary text-white font-bold border border-primary" : ""}`}>
          {/* Display Number */} 
          {step.completed ? (
