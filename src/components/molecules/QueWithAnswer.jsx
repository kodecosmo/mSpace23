...
const QueWithAnswer = () => {
  return (
    <section className="All-3-ans flex flex-col items-start mx-auto max-w-6xl w-full justify-center gap-12 mt-5">
      <div className="One-ans overflow-hidden flex flex-col justify-start items-start w-full max-w-4xl mx-auto rounded-md">
          ...
          <div className="flex flex-col items-start gap-3 m-5 w-full">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex items-center gap-2">
                <div>
                  <img src="" alt="profile pic" className=" w-4 h-4" />
                </div>
        ...
        {/* Answer 01 */}
        <div className="Que-ans flex items-center w-full gap-4 mx-auto max-w-[800px]">
          <svg
        ...
        {/* Answer 02 */}
        <div className="Que-ans flex items-center w-full gap-4 mx-auto mt-3 max-w-[800px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="4"
            height="137"
