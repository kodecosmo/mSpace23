...
const Question = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full mx-2 flex-1">
        <label className="font-bold text-gray-500 h-6 mt-3 text-xs leading-8">
        ...
        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
          <div className="space-y-1 text-center">
            ...
            <div className="flex text-sm text-gray-600">
              <label
                htmlFor="file-upload"
                className="relative cursor-pointer bg-white rounded-md font-medium text-primary-700 hover:text-[#FFA24A] focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:primary"
              >
