...
>>>>>>> Stashed changes
        ...
        <form className="flex flex-col">
          ...
          <button
            type="submit"
            className="focus:outline-none text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:ring-orange-300 rounded-lg text-md px-7 py-3 .5 mr-2 mb-2 dark:focus:ring-orange-900 font-semibold mt-10"
          >
            Create new account
          </button>
        </form>
