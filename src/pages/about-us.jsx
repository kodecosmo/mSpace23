            ...
            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
              <div className="lg:max-w-md">
                ...
                <p className="px-4 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                  ...
                  innovators driven by a shared vision—to enhance the learning
                  experience for students and educators alike. With countless
                  hours of dedication and expertise, we've brought
                  <span className="text-primary"> Que </span> to life, a
                  platform where questions find answers effortlessly, and
                  knowledge is shared seamlessly. Join us in this educational
                  revolution, where we believe that every question matters, and
                  every answer makes a difference.
                </p>
        ...
        <div className="justify-center flex-1 px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
          <div className="mb-10 text-center">
            ...
            <h1 className="text-3xl font-bold capitalize dark:text-white">
              {" "}
              Meet Team <span className="text-purple-500"> kode </span>
            </h1>
          </div>
