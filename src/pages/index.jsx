  ...
  return (
    <>
      ...
      <main style={{ marginTop: '80px' }} className='w-full'>
        <section className="w-full max-w-screen-xl mx-auto flex flex-col items-center justify-start text-left text-base">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-row items-start justify-start gap-3 text-[15.81px] mt-8">
                ...
                <div className="flex flex-row items-center justify-start gap-[14.05px]">
                  <img className="w-14 h-14" alt="" fill={true} src="/icon.svg" />
                  <div className="font-semibold">Ask Any Question</div>
                </div>
                
                <div className="flex flex-row items-center justify-start gap-[14.05px]">
                  <img className="w-14 h-14" alt="" fill={true} src="/icon1.svg" />
                  <div className="font-semibold">Schedule Tutoring Sessions</div>
                </div>

                <div className="flex flex-row items-center justify-start gap-[14.05px]">
                  <img className="w-14 h-14" alt="" fill={true} src="/icon2.svg" />
