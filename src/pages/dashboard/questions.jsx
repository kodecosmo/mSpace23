...
import SubmitAtom from '@/components/atoms/modals/SubmitAtom';
                                    ...
                                    fields={
                                        <form action="#">
                                            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                                ...
                                                <TextAtom type="text" text="Name" name="name" id="name" placeholder="Type product name" required={true} />

                                                <TextAtom type="text" text="Brand" name="brand" id="brand" placeholder="Product brand" required={true} />

                                                <TextAtom type="text" text="Price" name="price" id="price" placeholder="$..." required={true} />
                                                ...
                                                <SelectAtom
                                                    ...
                                                    required={true}
                                                    options={<>
                                                        <OptionAtom selected={true} text="Select category" />
                                                        <OptionAtom selected={true} value="TV" text="TV/Monitors" />
                                                        <OptionAtom selected={true} value="PC" text="PC" />
                                                        <OptionAtom selected={true} value="GA" text="Gaming/Console" />
                                                        <OptionAtom selected={true} value="PH" text="Phones" />
                                                    </>}
                                                />


                                                <TextareaAtom text="Description" name="description" id="description" placeholder="Write product description here" rows={4} required={true} />

                                            </div>

                                            <SubmitAtom text="Add new product" />
